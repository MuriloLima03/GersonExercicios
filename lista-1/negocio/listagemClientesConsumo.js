...
class ListagemClientesConsumo {
    constructor(clientes) {
        this.clientes = clientes;
    }
    listarTop10Consumidores() {
        console.log("\nLista dos 10 clientes que mais consumiram produtos ou serviços:");
        const sortedClientes = this.clientes.sort((a, b) => (b.getProdutosConsumidos.length + b.getServicosConsumidos.length) -
        ...
        top10Clientes.forEach((cliente, index) => {
            ...
            console.log(`   Total consumido: ${cliente.getProdutosConsumidos.length + cliente.getServicosConsumidos.length}`);
            console.log("--------------------------------------");
        });
        console.log("\n");
    }
    listarTop10MenosConsumidores() {
        console.log("\nLista dos 10 clientes que menos consumiram produtos ou serviços:");
        const sortedClientes = this.clientes.sort((a, b) => (a.getProdutosConsumidos.length + a.getServicosConsumidos.length) -
...
exports.default = ListagemClientesConsumo;
